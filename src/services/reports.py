...
PATIENT_COLUMNS: tuple[Column, ...] = (
    ...
    Column("emergency_phone", "Teléfono de emergencia", 18),
    Column("email", "Email", 30),
...
CONSULTATION_COLUMNS: tuple[Column, ...] = (
    ...
    Column("patient_emergency_phone", "Teléfono de emergencia", 20),
...
def consultations_query(filters: ConsultationFilters) -> Select:
    ...
    stmt = (
        select(
            ...
            Patient.emergency_phone.label("patient_emergency_phone"),
...
def _consultation_row(r) -> dict:
    ...
    return {
        ...
        "patient_emergency_phone": r.patient_emergency_phone,
